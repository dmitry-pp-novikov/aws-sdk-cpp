...
namespace Aws
{
  ...
  namespace S3
  {
    ...
    typedef std::function<void(const S3Client*, const Model::ListObjectsRequest&, Model::ListObjectsOutcome&&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > ListObjectsResponseReceivedHandler;
