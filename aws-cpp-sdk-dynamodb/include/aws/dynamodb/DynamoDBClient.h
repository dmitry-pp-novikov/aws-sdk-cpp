...
namespace Model
{
  ...
  class DynamoDBClient;
    ...
    typedef std::function<void(const DynamoDBClient*, const Model::GetItemRequest&, Model::GetItemOutcome&&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > GetItemResponseReceivedHandler;
    ...
    typedef std::function<void(const DynamoDBClient*, const Model::PutItemRequest&, Model::PutItemOutcome&&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > PutItemResponseReceivedHandler;
    ...
    typedef std::function<void(const DynamoDBClient*, const Model::UpdateItemRequest&, Model::UpdateItemOutcome&&, const std::shared_ptr<const Aws::Client::AsyncCallerContext>&) > UpdateItemResponseReceivedHandler;
